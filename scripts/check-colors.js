...
function checkLineage(name, colors, bg) {
    console.log(`\nChecking ${name} Lineage`)
...
checkLineage('Optimized Standard', palette.optimized, palette.optimized.BG)
checkLineage('Original Dracula', palette.dracula, palette.dracula.BG)
