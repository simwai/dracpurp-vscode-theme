...
1.  **Dracpurp (Default):** The core experience. Clean, sharp, and focused.
...
We believe in the power of contrast. The deep backgrounds allow the vibrant pinks (`#b83dff`) and purples (`#a025e7`) to pop without causing ocular fatigue during those long, complex debugging sessions. It’s about creating a "flow state" environment where the tool fades away, leaving only you and the logic of the system.
